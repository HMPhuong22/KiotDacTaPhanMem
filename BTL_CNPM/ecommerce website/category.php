...
<body>
   ...
   <section class="products">
      ...
      <div class="box-container">
         ...
         <?php
         $category = $_GET['category'];
         $select_products = $conn->prepare("SELECT * FROM `products` WHERE products.category_id LIKE '%{$category}%'");
         ...
         <?php
            ...
            echo '<p class="empty">Không có sản phẩm thuộc danh mục!</p>';
         }
         ?>
