...
if (isset($_GET['delete'])) {
   ...
   if ($select_products->rowCount() > 0) {
      ...
      unlink('../uploaded_img/' . $fetch_delete_image['icon']);
...
<body>
   ...
   <section class="show-products">
      ...
      <h1 class="heading">Danh sách danh mục</h1>
      ...
      <div class="box-container" style="display: block">
         ...
         ?>
               <div class="box" style="width: 100%; display: flex; justify-content: space-between; padding: 1rem">
                  ...
                  <div class="flex-btn">
                     <a href="update_cate.php?update=<?= $fetch_category['id']; ?>" class="option-btn" style="margin:0">Cập nhật</a>
                     <a href="cate.php?delete=<?= $fetch_category['id']; ?>" class="delete-btn" onclick="return confirm('delete this category?');" style="margin:0">Xóa</a>
                  </div>
               </div>
         <?php
            }
