...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <h1 class="fw-semibold mb-4 text-center text-dark">EDIT EMPLOYEE</h1>
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('employees.update', ['employee' => $employee->EMP_ID]) }}"
                                method="POST">
                                @method('PUT')
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="tensp"
                                        aria-describedby="emailHelp" placeholder="Nhập Địa Chỉ Nhân Viên" name="address"
                                ...
                                <div class="row mb-4">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="number" class="form-control" id="sdt"
                                            placeholder="Nhập Số Điện Thoại Nhân Viên" name="phone" value="{{$employee->PHONE}}">
                                    </div>
                                    <div class="col-lg-6 align-content-center">
                                        <label for="cccd" class="form-label">CCCD<span
                                                class="text-danger">(*)</span></label>
                                        <input type="number" class="form-control" id="sdt"
                                            placeholder="Nhập Số Căn Cước Công Dân " name="cccd" value="{{$employee->CCCD}}">
                                    </div>
