        ...
        <div class="col-lg-12 ">
            <div class="card">
                <div class="card-header" style="border-bottom: 10px solid #28a745 !important; ">
                    <h1 class="fw-semibold mb-4  text-dark">LIST STOCKOUT</h1>
                </div>
                <div class="card-body">
                                ...
                                <form action="{{ route('stockouts.store') }}" method="post">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h1 class="modal-title fs-5" id="staticBackdropLabel"> New Stockout</h1>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <select class="form-select customerSelect"
                                                                aria-label="Default select example" name="customer">
                                                                <option selected>---Please choose a custome---
                                                                </option>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <input type="text" class=" form-control "
                                                                        name="supplier" id="customerName" disabled>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <label for="">PhoneNumber </label>
                                                                    <input type="text" class=" form-control "
                                                                        name="supplier" id="customerPhone" disabled>
                                                                </div>
                                                            </div>
                                                            <label for="">Address </label>
                                                            <input type="text" class=" form-control "
                                                                name="supplier" id="customerAddress" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <script>
                                                    $(document).ready(function() {
                                                        ...
                                                        $('.customerSelect').on('change', function() {
                                                            ...
                                                            $.ajax({
                                                                url: '/admin/khachhang', // Đường dẫn tới phương thức xử lý yêu cầu Ajax để lấy thông tin sản phẩm
                                                                method: 'POST',
                                                                data: {
                                                                ...
                                                                success: function(response) {
                                                                    ...
                                                                    $('#customerName').val(response
                                                                        .name);
                                                                    $('#customerPhone').val(response
                                                                        .phone); // Hiển thị dữ liệu trong input
                                                                    $('#customerAddress').val(response
                                                                        .address);
                                                                },
                                                                error: function(xhr) {
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('stockouts.index') }}" class="btn btn-primary">Save</a>
                                        </div>
                    ...
                    <div class="table-responsive ">
                        <table class="table table-bordered table-hover " id="myTable">
                            ...
                            <tbody>
                                <?php $dem = 1; ?>
                                @foreach ($stockoutdetail as $data)
                                    <tr data-expanded="true">
                                        <td><?php echo $dem++; ?></td>
                                        <td>{{ date('d-m-Y', strtotime($data->stockout->CREATEDDATE)) }}
                                            <p>{{ date('H:i:s', strtotime($data->stockout->CREATEDDATE)) }}</p>
                                        </td>
                                        <td>{{ $data->stockout->customer->NAME }}</td>
                                        <td>{{ $data->product->NAME }}</td>
                                        <td>{{ $data->QUANTITY }}</td>
                                        <td>{{ $data->product->unit }}</td>
                                        <td>{{ number_format($data->QUANTITY * $data->product->PRICE, 0, ',', '.') }}₫
                                        </td>
                                        <td>{{ $data->stockout->employee->LASTNAME }}
                                            {{ $data->stockout->employee->FIRSTNAME }}</td>
                                        ...
                                        <td>
                                            <span class="d-flex">
                                                <button id="editStockoutButton" style="color: #17a2b8"
                                                    data-stockout-id="{{ $data->OUTD_ID }}" type="button"
                                                    class=" editStockoutButton h2 border border-0 float-end  bg-transparent"
                                                    data-bs-toggle="modal" data-bs-target="#editStockout">
                                                    <i class="ti ti-edit"></i></button>



                                                <a target="_blank"
                                                    href="{{ route('stockouts.show', ['stockout' => $data->OUTD_ID]) }}"
                    ...
                    <script>
                        $(document).ready(function() {
                            $('.editStockoutButton').click(function() {
                                var stockoutID = $(this).data(
                                    'stockout-id'); // Lấy ID từ biến PHP và gán cho biến JavaScript

                                //đoạn này dùng để lấy giá trị của id của button được chọn nhằm mục đích lấy được id của stockindetail để update
                                var actionURL = "{{ route('stockouts.update', ['stockout' => ':stockoutID']) }}";
                                actionURL = actionURL.replace(':stockoutID', stockoutID);
                                $('#stockinForm').attr('action', actionURL);

                                // $('#stockinForm').submit();
                                $.ajax({
                                    url: '/admin/Editstockouts/' +
                                        stockoutID, // Đường dẫn tới phương thức xử lý yêu cầu Ajax để lấy thông tin sản phẩm
                                    type: 'GET',
                                    ...
                                    success: function(response) {
                                        ...
                                        $('#customerName1').val(response.customerName);
                                        $('#title').text(response.customerName);
                                        $('#customerPhone1').val(response
                                            .customerPhone); // Hiển thị dữ liệu trong input
                                        $('#customerAddress1').val(response
                                            .customerAddress);
                                    },
                    ...
                    <div class="modal fade" id="editStockout" data-bs-backdrop="static" data-bs-keyboard="false"
                        tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog modal-fullscreen">
                            <form id="stockinForm"
                                action="{{ route('stockouts.update', ['stockout' => $data->OUTD_ID]) }}"
                                method="post">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <i class="ti ti-info-circle h1"></i>
                                        <h1 class="modal-title fs-5" id="staticBackdropLabel">EDIT STOCKOUT - <span
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <select class="form-select customerSelect"
                                                            aria-label="Default select example" name="customer1">
                                                            <option selected>---Please choose a customer---
                                                            </option>
                                                            @foreach ($customer1 as $customer1)
                                                                <option value="{{ $customer1->CUS_ID }}">
                                                                    {{ $customer1->NAME }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    <div class="col-lg-6">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                ...
                                                                <input type="text" class=" form-control "
                                                                    name="customer" id="customerName1" disabled>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <label for="">PhoneNumber </label>
                                                                <input type="text" class=" form-control "
                                                                    name="customer" id="customerPhone1" disabled>
                                                            </div>
                                                        </div>
                                                        <label for="">Address </label>
                                                        <input type="text" class=" form-control " name="customer"
                                                            id="customerAddress1" disabled>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- đoạn script lấy dữ liệu nhà cung cấp --}}
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <span class="d-flex fw-bold ">
                                                                    <i class="ti ti-list-details h2 me-1"
                                                                        style="color:#1e8bff;"></i>
                                                                    <h2 style="color:#1e8bff;">StockoutDetail</h2>
                                                                </span>
