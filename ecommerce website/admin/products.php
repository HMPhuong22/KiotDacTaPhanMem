...
if (isset($_POST['add_product'])) {
   ...
   if ($select_products->rowCount() > 0) {
      ...
      $insert_products = $conn->prepare("INSERT INTO `products`(name, details, quantity, import_price, price, image_01, image_02, image_03, category_id, storage_id) VALUES(?,?,?,?,?,?,?,?,?,?)");
      $insert_products->execute([$name, $details, $qty, $ip_price, $price, $image_01, $image_02, $image_03, $category, $storage]);
   ...
   <section class="add-products">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         <div class="flex">
            ...
            <div class="inputBox">
               <span>Import price (required)</span>
      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <div class="name">Stock: <?= $fetch_products['quantity']; ?></div>
                  <div class="price" style="color: #e03">Import price: $<span><?= $fetch_products['import_price']; ?></span></div>
                  <div class="price">Sold price: $<span><?= $fetch_products['price']; ?></span></div>
