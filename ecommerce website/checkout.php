...
if(isset($_POST['order'])){
   ...
   if($check_cart->rowCount() > 0){
      ...
      $messageTo = "Đặt hàng thành công";
      $headers = "From: Alex@gmail.com\r\n";
      $headers .= "Reply-To: Alex@gmail.com\r\n";
      $headers .= "CC: cc@example.com\r\n";
      $headers .= "BCC: bcc@example.com\r\n";
      
      if (mail($to, $subject, $messageTo, $headers)) {
      ...
      // Gửi thông báo đặt hàng thành công về Gmail
   ...
   //  $mail->IsHTML(true);
   //  $mail->Username = "nguyenduchbym@gmail.com";
   //  $mail->Password = "poyapvnkyoohrfoy";
   //  $mail->SetFrom("nguyenduchbym@gmail.com");
   //  $mail->Subject = "Test";
   //  $mail->Body = "hello";
